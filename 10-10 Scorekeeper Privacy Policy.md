...
- __Application__ refers to 10-10 Scorekeeper, the software program provided by the Company.
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to 10-10 Scorekeeper.
- __Country__ refers to:  South Africa
...
While using Our Service, We do not ask You to provide Us with any personally identifiable information that can be used to contact or identify You. In order to use the Service you will be required to provide a nickname which is not identifiable.

#### Usage Data

No Usage Data is collected automatically when using the Service.
...
We do not also collect information that Your browser sends whenever You visit Our Service or when You access the Service by or through a mobile device.
...
- By email: ianweatherburn@gmail.com
- By visiting this page on our website: [https://github.com/ianweatherburn/10-10-Scorekeeper-Support/blob/b5b3146436d5689678ece929242db29295b9370a/README.md](https://github.com/ianweatherburn/10-10-Scorekeeper-Support/blob/b5b3146436d5689678ece929242db29295b9370a/README.md)
